...
read : [
  ...
  onReadStatusChange = (shelf, book) => {
    // Search for the list where it has the title and remove it
   this.setState({
     currentlyReading: this.state.currentlyReading.filter(
       (b) => b.title !== book.title
     ),
     wantToRead: this.state.wantToRead.filter((b) => b.title !== book.title),
     read: this.state.read.filter(
       (b) => b.title !== book.title
     ),
   });

   //currentlyReading.find((book) => book.title === title)
              ...
              <div>
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <BooksGrid
                      readingList={this.state.currentlyReading}
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <BooksGrid
                      readingList={this.state.wantToRead}
                      onReadStatusChange={this.onReadStatusChange}
                    />
                  </div>
                </div>
